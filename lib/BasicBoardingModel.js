...
// var legend = [
//     { "name": "Interactive Boarding Interface", "location": { "row": 3, "col": 17 } },
//     { "name": "Legend (Passenger Colour): ", "location": { "row": 12, "col": 31.5 } },
//     { "name": "White - Walking", "location": { "row": 12.7, "col": 31.5 } },
//     { "name": "Yellow - Storing Bag", "location": { "row": 13.4, "col": 31.5 } },
//     { "name": "Red - Shuffling Seats", "location": { "row": 14.1, "col": 31.5 } },
//     { "name": "Black - Seated", "location": { "row": 14.8, "col": 31.5 } },
// ]
...
function redrawWindow() {
    ...
    window.BAGGAGESTORELOWERLIMIT = Math.max(parseInt(document.getElementById("bagstoringtime").value) - 2, 0);
    window.BAGGAGESTOREUPPERLIMIT = Math.min(parseInt(document.getElementById("bagstoringtime").value) + 2, document.getElementById("bagstoringtime").value * 2 - BAGGAGESTORELOWERLIMIT);
...
function updateSurface() {
    ...
    // var alllegend = surface.selectAll(".legend").data(legend)
    // var newlegend = alllegend.enter().append("g").attr("class", "legend");
    ...
    // alllegend.selectAll("text").text(function (d) {
    //     return d.name
    // })
...
function addDynamicAgents(counter) {
    ...
    if (idCount <= numPassengers && aisleList[queueStartCol] == EMPTY && counter % INTERVAL == 0) {
        ...
        var newPassenger = {
            ...
            // Uniform Distribution [BAGGAGESTORELOWERLIMIT, BAGGESTOREUPPERLIMIT]
            "baggageStoringTime": BAGGAGESTORELOWERLIMIT + Math.floor(Math.random() * Math.floor(BAGGAGESTOREUPPERLIMIT - BAGGAGESTORELOWERLIMIT)),
...
function getStatistics() {
    ...
    if (seatedPassengers.length < numPassengers) {
        ...
        // Print statistics
        console.log("Boarding Model: " + window.boardingmethod);
