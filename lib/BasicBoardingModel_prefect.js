...
function assignSeats() {
    ...
    // 2. Create list for the passnegers (Ryan code)
    unassignedPassengers = [];
    count = 0;
    for (i = 1; i <= numPassengers; i++) {
        unassignedPassengers.push(i);
    }
    console.log(unassignedPassengers)

    // 3. Order Passenger Seating Arrangement
    seat_assigned_order = []
    for(i of grp_list){
        console.log(i)
        // for seat arrangement of 1st grps
        if(i%1 == 0){
        ...
        // for seat arrangement of 2nd grps
        else if(i%1==0.5){
    ...
    console.log(seat_assigned_order)

    //4. Link the seat Matrix to the passenger
    // using unassignedPassengers and seat_assigned_order
    for(var i = 0; i < unassignedPassengers.length ; i++ ){
        console.log(seat_assigned_order[i])
        console.log(unassignedPassengers[i])
        seatMatrix[seat_assigned_order[i]].passengerID = unassignedPassengers[i];
    }
    console.log(seatMatrix[209])
